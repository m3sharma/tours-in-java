...
<html lang="en" dir="ltr">
	...
	<body>
				...
				<div class="container">
					...
					<div id="page">
						...
						<section id="signup-form">
							<h2 class="ft-heading text-upper">Tour Booking Request</h2>
     ...
     try
                  {
                    String q1="select * from bookingrequest,tours,usertable "
                            + "where bookingrequest.tourid=tours.tourid "
                            + "and bookingrequest.username=usertable.emailid order by requestdate desc";
                    ...
                    if(myresult.next())
                    {
                        ...
                        out.println("<tr bgcolor='yellow'><td>Username</td><td>Name</td><td>Phone</td><td>Tour</td><td>Departure Date</td><td>Return Date</td><td>Persons</td><td>Date of Request</td></tr>");
                        do
                        {
                           
                                out.println("<tr>");
                            
                            out.println("<td>" + myresult.getString("username") + "</td>");
                             out.println("<td>" + myresult.getString("usertable.name") + "</td>");
                             out.println("<td>" + myresult.getString("phone") + "</td>");
                            out.println("<td>" + myresult.getString("name") + "</td>");
                            out.println("<td>" + myresult.getString("ddate") + "</td>");
                            out.println("<td>" + myresult.getString("rdate") + "</td>");
                            out.println("<td>" + myresult.getString("persons") + "</td>");
                            out.println("<td>" + myresult.getString("requestdate") + "</td>");
                            out.println("</tr>");                            
                        }
                        while(myresult.next());
                        out.println("</table>");
